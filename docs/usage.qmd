...
[SatTCR](https://github.com/Ong-Research/SatTCR) is publicly available on [GitHub](www.github.com). SatTCR can be downloaded from the command line using the command:
...
The configuration file is separated into the following sections:
